            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center justify-center h-screen">
                ...
                <AnimatedContent distance={30} delay={0.1}>
                    <h1 className="text-center font-urbanist text-5xl/15 md:text-6xl/18 mt-4 font-bold max-w-2xl">
                        <span style={{ color: '#eef9f8' }}>You&apos;re scaling.</span>
                        <br />
                        <span className="text-gray-800">Half of it should be <span className="underline decoration-2 underline-offset-4">automated.</span></span>
                    </h1>
                </AnimatedContent>

                <AnimatedContent distance={30} delay={0.2}>
                    <p className="text-center text-base/7 text-zinc-700 max-w-xl mt-4">
                        The role you&apos;re hiring for has real judgment work at the center. Around it is prep, cleanup, and repetition that buries whoever you hire. We automate that layer in 30 days and hand it off.
                        <br /><br />
